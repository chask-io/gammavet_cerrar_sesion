...
Cierra la sesion de orquestacion del conductor Gammavet sin modificar paradas de ruta
...
- The function name matches "CerrarSesionFn"
...
- AWS CloudWatch Logs: `/aws/lambda/CerrarSesionFn`
- Chask dashboard: Organization → Functions → CerrarSesionFn
